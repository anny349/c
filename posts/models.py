...
class Post(models.Model):
    ...
    post_type = models.CharField(max_length=10, choices=POST_TYPES, default=TEXT)  # Post type
    metadata = models.JSONField(default=dict)  # Additional metadata for post types
